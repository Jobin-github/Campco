...
class CSI extends StatefulWidget {
  const CSI({Key? key}) : super(key: key);

  @override
  _CSIState createState() => _CSIState();
}

class _CSIState extends State<CSI> {
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: AssetImage('assets/CSI.png'),
                ),
              ),
            ),
            const SizedBox(
