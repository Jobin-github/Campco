...
class Spectra extends StatefulWidget {
  const Spectra({Key? key}) : super(key: key);

  @override
  _SpectraState createState() => _SpectraState();
}

class _SpectraState extends State<Spectra> {
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: AssetImage('assets/photo_2022-07-09_01-33-39.jpg'),
                ),
              ),
            ),
            const SizedBox(
