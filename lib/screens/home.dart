...
import 'package:campco2/screens/PSocieties/IEEE.dart';
                        ...
                        child: Container(
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              ...
                              MaterialPageRoute(builder: (context) => const IEEE()));
                                      },
                                        child: Container(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: (){
                                        Navigator.push(context,
                              MaterialPageRoute(builder: (context) => const CSI()));
                                      },
                                        child: Container(
                                          decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image:
                                                    AssetImage('assets/CSI.png'),
                                                fit: BoxFit.cover),
                                            //color: Colors.green,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage('assets/GDC.png'),
                                              fit: BoxFit.fill),
                                          //color: Colors.green,
                                          shape: BoxShape.circle,
                                        ),
